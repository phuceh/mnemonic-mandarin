...
export default function Landing() {
  ...
  const features = [
    ...
    { emoji: '🎯', title: 'HSK aligned', desc: 'Content follows the HSK standard, the international benchmark for Mandarin proficiency. HSK1-3 is available now, with more levels coming soon.' },
  ]
  ...
  return (
    <div style={{ background: s.bg, minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: 800, margin: '0 auto', padding: '2rem 2rem 4rem', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 14, color: s.muted, marginTop: 12 }}>HSK1-3 available now · HSK4+ coming soon · Cancel subscription anytime · Lifetime access available</div>
      </section>
      ...
      <section style={{ background: s.red, padding: '5rem 2rem', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)', marginTop: 12 }}>HSK1-3 available now · HSK4+ coming soon · Cancel subscription anytime · Lifetime access available</div>
      </section>
      ...
      <footer style={{ background: s.card, borderTop: '1px solid #e8ddd0', padding: '2rem', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 12, color: s.lightbrown, marginBottom: 8 }}>Mandarin vocabulary with mnemonics · HSK1-3 available now</div>
